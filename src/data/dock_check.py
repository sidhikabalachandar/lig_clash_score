...
save_path = '/oak/stanford/groups/rondror/projects/combind/flexibility/atom3d/refined_random_with_unaligned.txt'
...
def main():
    ...
    with open(args.docked_prot_file) as fp:
        for line in fp:
            ...
            folder = os.path.join(data_root, '{}/docking/sp_es4/{}-to-{}'.format(protein, target, start))
