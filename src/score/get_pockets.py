...
$ $SCHRODINGER/run python3 get_pockets.py /home/users/sidhikab/lig_clash_score/src/sample/test/run /oak/stanford/groups/rondror/projects/combind/flexibility/atom3d --data_name balanced_data
"""
