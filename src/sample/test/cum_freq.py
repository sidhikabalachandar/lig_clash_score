...
def main():
    ...
    for protein, target, start in [('P02829', '2weq', '2yge'), ('P00797', '3own', '3d91'), ('C8B467', '5ult', '5uov')]:
        ...
        last_glide = min(sorted_glide[:args.num_poses_graphed - 1], key=lambda x: x[1])
        print('glide:', last_glide)
        file_name = '{}.mae'.format(last_glide[2])
        ...
        conformer_index, grid_loc_x, grid_loc_y, grid_loc_z, rot_x, rot_y, rot_z = last_python[2].split('_')
