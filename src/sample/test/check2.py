...
$ $SCHRODINGER/run python3 check2.py /oak/stanford/groups/rondror/projects/combind/flexibility/atom3d/splits/search_test_incorrect_glide_index.txt /home/users/sidhikab/lig_clash_score/src/sample/test/run /oak/stanford/groups/rondror/projects/combind/flexibility/atom3d/raw
"""
...
def main():
    ...
    if not os.path.exists(pose_file):
        ...
        idx = random.choice(tolerable_indices)
        max_clash = 0
        max_clash_idx = -1

        for pose_index in range(idx, idx + 100):
            ...
            if volume_docking > max_clash:
                max_clash = volume_docking
                max_clash_idx = pose_index
                print('idx:', pose_index, 'volume docking:', volume_docking, 'start_clash', start_clash)
